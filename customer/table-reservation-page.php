...
<body>
    ...
    <main>
        <section class="gallery-container-table" id="gallery">
            <div class="gallery-table">
                ...
                <div class="picture-grid">
                    ...
                    <div class="picture-container"><img src="pictures/table-pictures/3.jpeg"></div>
        ...
        <div class="right-section">
            <div class="contact-box">
                ...
                <div class="location">
                    ...
                    <p><span>Address:</span> 40/9, Aueburn side, Colombo </p>
                </div>
                <div class="tel-no">
